...
#set_property -dict { PACKAGE_PIN U15  IOSTANDARD LVCMOS33 } [get_ports { led[6] }]; #IO_L23P_T3_A03_D19_14        ,Sch=LED5
...
set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { o_y }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
